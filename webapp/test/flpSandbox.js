		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title sunitha",
									"targetURL": "#comsunmyproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsunmyproject-display": {
								"semanticObject": "comsunmyproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sun.myproject",
									"url": sap.ui.require.toUrl("com/sun/myproject")
								}
							}
						}
					}
